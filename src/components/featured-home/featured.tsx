...
export function FeaturedProducts() {
    ...
    return (
      <section className="my-12">
        <h2 className="mb-6 text-2xl font-semibold md:text-3xl">Featured & Recommended</h2>
                ...
                <Card className="overflow-hidden rounded-lg shadow-lg transition-transform duration-300 hover:scale-105">
                  <CardContent className="p-0">
                    ...
                    <div className="bg-gradient-to-t from-black/80 to-transparent p-4">
                      ...
                      <p className="mt-2 text-sm text-gray-300">{product.description.substring(0, 100)}...</p>
                    </div>
                  </CardContent>
                </Card>
              </CarouselItem>
