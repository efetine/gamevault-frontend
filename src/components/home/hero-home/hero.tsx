...
export function HeroSection() {
  return (
    <section className="relative h-full w-full overflow-hidden ">
      <div className="flex flex-col lg:flex-row lg:h-[60vh]">
        <div className="relative w-full h-[30vh] lg:h-full lg:w-3/4">
        <img
        src="/horizon.png"
        alt="Hero background"
        className="h-full w-full object-cover"
      />
        ...
        <div className="flex items-center justify-center w-full lg:w-1/4 bg-gradient-to-tr from-yellow-100/10 to-blue-700/20 p-8 lg:p-12">
          <motion.div
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            ...
            <p className="mx-auto lg:mx-0 max-w-2xl text-sm text-gray-700 dark:text-white sm:text-lg lg:text-xl">
              We are the first e-commerce specialist to offer everything related
              to your favorite hobby in one place, from digital games to
              accessories and much more.
            </p>
