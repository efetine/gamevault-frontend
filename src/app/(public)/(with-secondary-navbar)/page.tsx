...
const HomePage = () => {
  return (
    <div className="mt-20 flex min-h-screen w-full flex-col items-center justify-start bg-red-50 from-[#0d1117] via-[#1a2332] to-black dark:bg-gradient-to-b dark:text-white">
      <HeroSection />
